define(['MyParcelNL_Magento/js/view/delivery-options'], function(deliveryOptions) {
    ...
    const mixin = {
         ...
         * Unfortunately the original summary/shipping script does not get an updated quote, and will display stale titles.
         *
         * @returns {*}
         */
        getShippingMethodTitle: function () {
            if (deliveryOptions.isUsingMyParcelMethod) {
                try {
                    const shippingMethod = JSON.parse(localStorage.getItem(deliveryOptions.localStorageShippingMethod));
